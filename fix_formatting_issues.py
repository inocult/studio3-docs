#!/usr/bin/env python3
"""Fix common formatting issues across markdown files."""
...
priority_files = [
    'docs/anchors-guide/guiding-founders.md',
    'docs/anchors-guide/quality-criteria.md',
    'docs/anchors-guide/responsibilities.md',
    'docs/anchors-guide/complex-cases.md',
    'docs/echoes-guide/portfolio-strategies.md',
    'docs/anchors-guide/reputation-management.md',
    'docs/anchors-guide/anchor-council.md',
    'docs/anchors-guide/anchor-progression.md',
    'docs/senders-guide/winning-strategies.md',
    'docs/senders-guide/handling-doubt.md'
]

def main():
    """Fix formatting issues in priority files."""
    total_fixed = 0
