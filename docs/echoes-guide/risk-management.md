...
```
Signal Size = Kelly × 0.25 × Bankroll
...
- Smoother growth
```
**Practical Sizing Table:| Confidence | Win Rate | Multiplier | Max Size |
|------------|----------|------------|----------|
| Very High | 80% | 2x | 5% |
| High | 70% | 2x | 3% |
| Medium | 60% | 2x | 2% |
...
- 100% loss possible
- Survival plan: ____
**Regular Testing:Run scenarios monthly
...
- Discipline decay
- Isolation effects
**Prevention:Regular rule review
